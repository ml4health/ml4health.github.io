  ...
  <div class="row display-flex">
      ...
      <div class="col-xs-6 col-md-4">
        <div class="thumbnail">
          ...
          <img
              src="{filename}/images/headshots_200x200/200x200_adrian.jpg"
      ...
      <div class="col-xs-6 col-md-4">
        <div class="thumbnail">
          ...
          <div class="caption">
              ...
              <br />
              <emph>Diversity & Inclusion Chair </emph>
              </p>
              <p></p>
          </div>
          </a>
      ...
      <div class="col-xs-6 col-md-4">
        <div class="thumbnail">
          <a href="">
          <img
              src="{filename}/images/headshots_200x200/200x200_jaz.jpg"
      ...
      <div class="col-xs-6 col-md-4">
        <div class="thumbnail">
            ...
            <img
                ...
                align="center">
            <div class="caption">
                <h5>Amelia Averitt </h5>
                <p> Columbia University
                <br />
                <emph>Travel Grants </emph>
                </p>
                <p></p>
            </div>
            </a>
...
<h2><a name='primary'>Senior Advisory Committee</a></h2>
<div class="container">
  <div class="row display-flex">
      <!-- 6/12 = 1/2 width on mobile, 4/12 = 1/3 screen on laptop -->
      <div class="col-xs-6 col-md-4">
      ...
      <div class="col-xs-6 col-md-4">
        <div class="thumbnail">
            ...
            <div class="caption">
                <h5>Andrew Beam</h5>
                <p>Harvard School of Public Health
                <br />
                <emph>Senior Advisory Committee</emph>
                </p>
                <p></p>
