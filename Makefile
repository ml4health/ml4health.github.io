...
BASEDIR=$(CURDIR)
INPUTDIR=$(BASEDIR)/2020_content
OUTPUTDIR=$(BASEDIR)/2020
...
papers:
	cd $(INPUTDIR)/organizer_data/ && python make_page__accepted_abstracts.py && python make_page__accepted_papers.py
